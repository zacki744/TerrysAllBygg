          ...
          <div className={styles.navLinks}>
            {links.map((l) => (
              <Link
                key={l.href}
                to={l.href}
                className={`${styles.navLink} ${location.pathname === l.href ? styles.navLinkActive : ""}`}
              >
                {l.label}
              </Link>
            ))}
          ...
          <div className={styles.mobileMenu} onClick={(e) => e.stopPropagation()}>
            {links.map((l) => (
              <Link
                key={l.href}
                to={l.href}
                className={`${styles.mobileMenuLink} ${location.pathname === l.href ? styles.mobileMenuLinkActive : ""}`}
              >
                {l.label}
              </Link>
            ))}
